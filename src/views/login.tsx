...
import { googleLogin } from "./functions/google_login"
...
export default function Login() {
    ...
    const login = () => loginFunc(emailRef, passRef, (response, error: any) => {
        if (error) { return !error.response!.data.acknowledged && alert(error.response!.data.msg) }
    ...
    useEffect(() => {
        if (user) {
            ...
            googleLogin(user, (response, error: any) => {
                if (error) {
